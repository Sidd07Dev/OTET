...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $otherDetailsUpdateQuery = "UPDATE $dbname  SET CNAME = '$candidateName', FNAME = '$fatherName', PASSYEAR = '$year', PAPEROPT = '$markPaper1',PAPEROPT2 = '$markPaper2', TOTAL = '$obtainMark', CASTE = '$category', CERTNO = '$certificateNo', SLNO = '$serialNo',UPDATEBY='$updateBy',UPDATETIME='$updateTime' WHERE ROLLNO = '$rollNo'";
