      ...
      $dop=test_input($_POST['dop']);
        ...
        // Redirect to success page or show success message
          ...
          if($flag==1){
            ...
            $res=new_Data($con,$table,$rollNo,$applNo,$cname, $fname,$paper1,$paper2,$caste, $mark,$serialNo,$certNo,$year, $image_path,$Time,$dop);
            if($res){
              header('location:candidateform.php');
              exit();
            }
...
function new_Data($con,$table,$rollNo,$applNo,$cname, $fname,$paper1,$paper2,$caste, $mark,$serialNo,$certNo,$year, $image_path,$Time,$dop){
  $flag=0;
  $user=$_SESSION['username'];
  $sql="INSERT INTO $table (`ROLLNO`, `OTETID`, `CNAME`, `FNAME`, `PAPEROPT`, `PAPEROPT2`, `CASTE`, `TOTAL`, `SLNO`, `CERTNO`, `PASSYEAR`, `DOP`, `PROFILEPATH`, `CreateTime`, `UPDATETIME`, `CreateBy`, `UPDATEBY`) VALUES('$rollNo','$applNo','$cname',' $fname','$paper1','$paper2','$caste', '$mark','$serialNo','$certNo','$year','$dop',' $image_path','$Time','not change yet','$user','not change yet') ";
  $res=$con->query($sql);
  if($res){
$flag=1;
  }
