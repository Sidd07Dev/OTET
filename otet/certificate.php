...
<body>
    ...
    <img src="logo.png" alt="John Doe Photo" style="width: 3em; margin-right: 0.5em; font-size: 1.3em;" class="center">
    <label class="mb-0" style="font-size: 2.5em;">Board Of Secondary Education, Odisha</label>
    <img src="logo.png" alt="John Doe Photo" style="width: 3em; margin-left: 0.5em; font-size: 1.3em;" class="center">
</div>
                    ...
                    <div class="card-body custom-card ">
                        ...
                        <div class="row">
                            <img src="<?php echo $row['PROFILEPATH'] ?>" alt="Applicant Profile Picture" class=" d-block" style="height: 6rem;">
